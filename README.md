...
This is a fork of the original repository [https://github.com/jonathansant/Orleans.Streams.Kafka](https://github.com/jonathansant/Orleans.Streams.Kafka), adding additional settings available in Confluent.Kafka, without which an SSL connection to Apache Kafka cannot be used.
...
## Testing
Instructions for testing the code are provided in a separate file: [Testing.md](Testing.md)
